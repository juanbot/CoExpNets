...
![Smoothing parameter study\label{fig:betastudy}](results/betastudyMyRosMap.signed.pdf)
...
![Module size before applying k-means\label{fig:modsize}](results/MyRosMap.4_mod_size.pdf)
...
![Eigengenes clustering before applying k-means\label{fig:egenes}](results/MyRosMap.4_Eigengenes_clustering.pdf)
...
![Module size after applying k-means\label{fig:modafter}](results/netMyRosMap.4.it.20.rds.mod_size.pdf)
...
![Eigengenes clustering after applying k-means\label{fig:egenesafter}](results/netMyRosMap.4.it.20.rds.Eigengenes_clustering.pdf)
...
![Cell type signals for our ROS/MAP Cortex network](results/netMyRosMap.4.it.20.rds.celltype.pdf)
